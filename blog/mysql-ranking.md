...
其实呢，这个需求，有部分数据库其实已经有内置的函数实现了，例如在MySQL 8.0里，我们直接用就可以，参考[通过dense_rank() over排名](#%E9%80%9A%E8%BF%87denserank-over%E6%8E%92%E5%90%8D)
...
这个需求，在MySQL 8.0里已经有内置的函数实现了，我们直接用就可以，参考[通过rank() over排名](#%E9%80%9A%E8%BF%87rank-over%E6%8E%92%E5%90%8D)
